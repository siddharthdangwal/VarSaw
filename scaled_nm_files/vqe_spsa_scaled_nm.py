...
if sim_type == 'no_noisy_sim':
    ...
    loss_filename = hamiltonian_string_elements[-1] +'_vqe_noisy_loss_' + sys.argv[1] + '_scaling_factor_' + sys.argv[4] + '.csv'
    params_filename = hamiltonian_string_elements[-1] +'_vqe_noisy_params_' + sys.argv[1] + '_scaling_factor_' + sys.argv[4] + '.csv'
