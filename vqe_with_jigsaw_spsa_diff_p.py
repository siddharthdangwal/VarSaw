...
if opt_level == 1:
    ...
    loss_filename = hamiltonian_string_elements[-1] + '_vqe_with_jigsaw_opt1_loss_' + sys.argv[1] + '_p' + sys.argv[4] +  '_.csv'
    params_filename = hamiltonian_string_elements[-1] + '_vqe_with_jigsaw_opt1_params_' + sys.argv[1] + '_p' + sys.argv[4] +  '_.csv'
    ...
    loss_filename = hamiltonian_string_elements[-1] + '_vqe_with_jigsaw_opt2_loss_' + sys.argv[1] + '_p' + sys.argv[4] +  '_.csv'
    params_filename = hamiltonian_string_elements[-1] + '_vqe_with_jigsaw_opt2_params_' + sys.argv[1] + '_p' + sys.argv[4] +  '_.csv'
